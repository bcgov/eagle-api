...
Common labels
*/}}
{{- define "eagle-api.labels" -}}
helm.sh/chart: {{ include "eagle-api.chart" . }}
{{ include "eagle-api.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "eagle-api.selectorLabels" -}}
